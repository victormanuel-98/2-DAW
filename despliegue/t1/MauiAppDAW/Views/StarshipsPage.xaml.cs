...
public partial class StarshipsPage : ContentPage
{
    ...
    public StarshipsPage(SwapiService? swapiService, SearchHistoryService? historyService)
    {
        InitializeComponent();
    ...
    private async void OnSearchClicked(object sender, EventArgs e)
    {
        ...
        {
            await _historyService.SaveStarshipsAsync(results);
        }
    }
    ...
    private async void OnSavedClicked(object sender, EventArgs e)
    {
        ...
        var saved = await _historyService.GetSavedStarshipsAsync();
