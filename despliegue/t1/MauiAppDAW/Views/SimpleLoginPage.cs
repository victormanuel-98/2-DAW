...
public class SimpleLoginPage : ContentPage
{
    ...
    public SimpleLoginPage()
    {
        ...
        passwordEntry = new Entry { Placeholder = "Contrasena", IsPassword = true };
        ...
        Content = new VerticalStackLayout
        {
            ...
            Children =
            {
                new Label { Text = "Iniciar sesion", Style = (Style)Application.Current.Resources["SW-Title"] },
                usernameEntry,
                passwordEntry,
                loginButton,
                messageLabel
    ...
    private async void OnLoginClicked(object? sender, EventArgs e)
    {
        ...
        {
            messageLabel.Text = "Usuario o contrasena incorrectos.";
        }
    }
}
